...
Calculator::Calculator() : wxFrame(nullptr, wxID_ANY, "Calculator", wxPoint(200, 200), wxSize(350, 500))
{
	...
	// 1st row buttons
	clearBtn = new wxButton(this, 400, "clear", wxPoint(30, 100), wxSize(50, 50));
	...
	button8 = new wxButton(this, 8, "8", wxPoint(130, 150), wxSize(50, 50));
	button9 = new wxButton(this, 9, "9", wxPoint(180, 150), wxSize(50, 50));
	mutliplyBtn = new wxButton(this, 400, "*", wxPoint(230, 150), wxSize(50, 50));
